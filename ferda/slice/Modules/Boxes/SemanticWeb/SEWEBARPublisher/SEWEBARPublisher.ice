...
#ifndef	FERDA_MODULES_BOXES_SEMANTICWEB_SEWEBARPUBLISHER
#define FERDA_MODULES_BOXES_SEMANTICWEB_SEWEBARPUBLISHER
...
module Ferda
{
  module Modules
  {
    module Boxes
    {
      module SemanticWeb
      {
        module SEWEBARPublisher
        {
           interface SEWEBARPublisherFunctions
           {
           };
        };
      };

    ...
    namespace ModulesManager
    {
        ...
        public class BoxModule : BoxModuleForManager
        {
            ...
            public override string RunSetPropertyOther(string name)
            {
                ...
                if (prx == null)
                {
                    if (String.IsNullOrEmpty(settingModuleIdentifier))
                        throw new Exception("Proxy of setting module is null. \"settingModuleIdentifier\" of the property is null or empty");
                    throw new Exception("Proxy of setting module is null.");
                }

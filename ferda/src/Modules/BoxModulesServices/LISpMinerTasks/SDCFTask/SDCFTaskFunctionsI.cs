...
using Ferda.Modules.Boxes.SDCFTask.Quantifiers.AbstractSDCFQuantifier;
...
{
    class SDCFTaskFunctionsI : SDCFTaskFunctionsDisp_, IFunctions
    {
        ...
        public override QuantifierProvider[] getQuantifierProviders(Ice.Current __current)
        {
            ...
            foreach (BoxModulePrx prx in getAbstractSDCFQuantifierBoxModulePrx())
            {
                ...
                item.functions = AbstractSDCFQuantifierFunctionsPrxHelper.checkedCast(prx.getFunctions());
                result.Add(item);
            }
        ...
        private CategorialPartialCedentSettingStruct[] getCategorialPartialCedentSettingSeq(string socketName)
        {
            ...
            bool oneAtMinimum = (socketName == "AntecedentSetting" || socketName == "FirstCedentSetting");
        ...
        private BoxModulePrx[] getAbstractSDCFQuantifierBoxModulePrx()
        {
            return SocketConnections.GetBoxModulePrxs(boxModule, "SDCFQuantifier", false);
        }
        ...
        public void RunActionRun()
        {
            ...
            //run task
            MetabaseLayer.SDCFTask metabaseLayer = new MetabaseLayer.SDCFTask();

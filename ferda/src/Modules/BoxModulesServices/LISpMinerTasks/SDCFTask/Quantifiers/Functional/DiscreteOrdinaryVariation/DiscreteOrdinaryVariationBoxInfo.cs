...
namespace Ferda.Modules.Boxes.SDCFTask.Quantifiers.Functional.DiscreteOrdinaryVariation
{
	class DiscreteOrdinaryVariationBoxInfo : Ferda.Modules.Boxes.SDCFTask.Quantifiers.AbstractSDCFTaskQuantifierBoxInfo
	{

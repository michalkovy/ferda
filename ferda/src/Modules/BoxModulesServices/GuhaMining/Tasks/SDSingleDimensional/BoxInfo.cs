// BoxInfo.cs - BoxInfo class for the SDCF task box
//
...
{
    /// <summary>
    /// Class that provides info about boxes of the SDCF task type
    /// </summary>
    internal class BoxInfo : Boxes.BoxInfo
    {
        ...
        /// </summary>
        public const string typeIdentifier = "GuhaMining.Tasks.SDSingleDimensional";

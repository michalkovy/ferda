// Functions.cs - Function objects for the 4FT task box module
//
...
{
    /// <summary>
    /// Class is providing ICE functionality of the 4FT task
    /// box module
    /// </summary>
    public class Functions : MiningTaskFunctionsDisp_, IFunctions, ITask
    {
        ...
        public void Run()
        {
            ...
            Common.RunTask(_boxModule, this, TaskTypeEnum.FourFold, ResultTypeEnum.Trace);
#endif
        }
    }
}
// Functions.cs - Function objects for the SDKL task box module
//
...
{
    /// <summary>
    /// Class is providing ICE functionality of the SDKL task
    /// box module
    /// </summary>
    public class Functions : MiningTaskFunctionsDisp_, IFunctions, ITask
    {
        ...
        public void Run()
        {
            ...
            Common.RunTask(_boxModule, this, TaskTypeEnum.SDKL,ResultTypeEnum.Trace);
        }
    }
}
// BoxInfo.cs - BoxInfo class for the CF task box
//
...
{
    /// <summary>
    /// Class that provides info about boxes of the CF task type
    /// </summary>
    internal class BoxInfo : Boxes.BoxInfo
    {
        ...
        /// </summary>
        public const string typeIdentifier = "GuhaMining.Tasks.SingleDimensional";

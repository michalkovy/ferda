...
//
// Authora: Daniel Kupka <kupkd9am@post.cz>
...
{
    /// <summary>
    /// Computes the Above negation quantifier
    /// </summary>
    /// <remarks>
    /// The quantifier is a stronger conditionality than the Founded implication
    /// quantifier. It is a symmetricat quantifier with formula
    /// (ac + ad)/(ac + bc).
    /// The quantifier belongs to the class of equivalence quantifiers. 
    /// </remarks>
            ...
            return ExceptionsHandler.TryCatchMethodThrow<double>(
                delegate
                {
                    ...
                    if (table.C == 0)
                        ...
                        return (table.A*table.C + table.A*table.D)/

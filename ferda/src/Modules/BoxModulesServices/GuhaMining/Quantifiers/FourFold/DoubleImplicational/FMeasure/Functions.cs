// Functions.cs - Function objects for the FMeasure quantifier box module
//
...
{
    /// <summary>
    /// Computes the FMeasure Quantifier
    /// </summary>
    /// <remarks>
    /// The formula for the quantifier is 
    /// 2a/2a+b+c. It is used for quality measuerment of decision trees.
    /// </remarks>
        ...
        public override double ComputeValue(QuantifierEvaluateSetting param, Current current__)
        {
            return ExceptionsHandler.TryCatchMethodThrow<double>(
                delegate
                {
                    ...
                    {
                        double up = 2*table.A;
                        double down = 2*table.A + table.B + table.C;
                        return up / down;
                    }
                },

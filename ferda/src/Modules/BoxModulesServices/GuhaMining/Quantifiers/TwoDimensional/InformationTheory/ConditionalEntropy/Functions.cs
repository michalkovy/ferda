...
namespace Ferda.Modules.Boxes.GuhaMining.Quantifiers.TwoDimensional.InformationTheory.ConditionalEntropy
{
    /// <summary>
        ...
        public override double ComputeValue(QuantifierEvaluateSetting param, Current current__)
        {
            ...
            switch (DependenceDirection)
            {
                case DependenceDirection.RowsOnColumns:
                    return Guha.Math.InformationTheory.ConditionalRCEntropyValue(table);
                case DependenceDirection.ColumnsOnRows:
                    return Guha.Math.InformationTheory.ConditionalCREntropyValue(table);
                default:

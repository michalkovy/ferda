...
namespace Ferda.Modules.Boxes.GuhaMining.Quantifiers.OneOrTwoDimensional.Aggregation.Average
{
    internal class BoxInfo : Boxes.BoxInfo
    {
        ...
        public const string typeIdentifier = "GuhaMining.Quantifiers.OneOrTwoDimensional.Aggregation.Average";

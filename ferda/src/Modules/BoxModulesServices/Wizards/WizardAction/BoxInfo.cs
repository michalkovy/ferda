// BoxInfo.cs - BoxInfo class for the wizardAction box
//
...
namespace Ferda.Modules.Boxes.Wizards.WizardAction
{
    /// <summary>
    ...
    internal class BoxInfo : Boxes.BoxInfo
    {
        ...
        public override Ferda.Modules.ModulesAskingForCreation[] GetModulesAskingForCreation(string[] localePrefs, Ferda.Modules.BoxModuleI boxModule)
        {
            ...
            foreach (string moduleAFCname in modulesAFC.Keys)
            {
                ...
                {
                    case "WizardGenerated":
                        moduleConnection.socketName = "Generated Input";
                        moduleConnection.boxModuleParam = boxModule.MyProxy;
                        singleModule.modulesConnection =
                                                    new ModulesConnection[] { moduleConnection };
                        singleModule.newBoxModuleIdentifier = Wizards.WizardGenerated.BoxInfo.typeIdentifier;
                        break;
        ...
        /// </summary>
        public const string typeIdentifier = "Wizards.WizardAction";

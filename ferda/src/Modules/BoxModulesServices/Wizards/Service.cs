...
using Ferda.Modules.Boxes.Wizards.WizardForm;
using Ferda.Modules.Boxes.Wizards.WizardAction;
using Ferda.Modules.Boxes.Wizards.WizardGenerated;
using Ice;
...
namespace Ferda.Modules.Boxes.Wizards
{
    ...
    public class Service : FerdaServiceI
    {
        ...
        protected override void registerBoxes()
        {
            ...
            registerBox(WizardForm.BoxInfo.typeIdentifier, new WizardForm.BoxInfo());
            registerBox(WizardAction.BoxInfo.typeIdentifier, new WizardAction.BoxInfo());
            registerBox(WizardGenerated.BoxInfo.typeIdentifier, new WizardGenerated.BoxInfo());
        }
    }
}

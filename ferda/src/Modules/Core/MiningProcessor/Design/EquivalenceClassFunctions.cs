// EquvalenceClassFunctions.cs - Function
//
...
{
    /// <summary>
    /// Interface for classes of equivalence
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Gets the identifications of the bit string generators that
        /// belong into this class of equivalence.
        /// </summary>
        /// <returns>Identification of bit string generators</returns>
        Guid[] FetEquivalenceClass();
    }
}
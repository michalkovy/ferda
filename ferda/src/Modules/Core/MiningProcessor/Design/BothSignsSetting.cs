// BothSignsSetting.cs - Represents Boolean attribute setting and its negation
//
...
{
    /// <summary>
    /// Represents a setting of a Boolean attribute (entity) and its negation.
    /// That means that in the bit string generation phase, the box <c>Sign</c>
    /// will generat the bit string corresponding to operand Boolean attribute
    /// setting and negation of these bit strings as well. 
    /// </summary>
    /// <remarks>

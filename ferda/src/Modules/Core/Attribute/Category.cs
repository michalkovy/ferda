// Category.cs - functionality of a category of an attribute
//
...
namespace Ferda.Guha.Attribute
{
    ...
    /// quite complex, it can be composed of collection of intervals and
    /// collection of values (enumerations).
    /// </summary>

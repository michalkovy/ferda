// Combinatorics.cs - Combinatorics functions
//
...
namespace Ferda.Guha.Math
{
    ...
    public sealed class Combinatorics
    {
        ...
        static Combinatorics()
        {
            ...
            {
                logFactorial += System.Math.Log(i);
        ...
        public static double LogFactorial(double input)
        {
            if (input < 0)
                throw new ArgumentOutOfRangeException("input", input,
                                                      "LogFactorial can be computed from non-negative integers only.");

            // use gamma function for bigger values
            return SpecialFunction.lgamma(input + 1);
        }
        ...
        public static long Factorial(int input)
        {
            if (input < 0)
                throw new ArgumentOutOfRangeException("input", input,
                                                      "Factorial can be computed from non-negative integers only.");
            if (input >= _factorialsMax)
                throw new OverflowException(
                    String.Format(CultureInfo.InvariantCulture,
                                  "Factorial can be computed from integers less than {0} only.", _factorialsMax));
        ...
        public static double FactorialDouble(int input)
        {
            if (input < 0)
                throw new ArgumentOutOfRangeException("input", input,
                                                      "FactorialDouble can be computed from non-negative integers only.");
            if (input >= _factorialsDoubleMax)
                throw new OverflowException(
                    String.Format(CultureInfo.InvariantCulture,
                                  "FactorialDouble can be computed from integers less than {0} only.",
                                  _factorialsDoubleMax));
        ...
        public static long BinomialCoefficient(int n, int k)
        {
            if (k < 0)
                throw new ArgumentOutOfRangeException("k", k,
                                                      "BinomialCoefficient can be computed for non-negative k only.");
            if (n < k)
                throw new ArgumentOutOfRangeException("n", n,
                                                      "BinomialCoefficient must have n greater than or equal to k.");
            ...
            // lock the triangle before accessing it to allow multiple threads
            // to call this method simultaneously
            lock (_pascalTriangle)
            {
        ...
        {
            return ((start + end)*(System.Math.Abs(start - end) + 1))/2;
        }
        ...
        public static double LogGamma(double value)
        {
            ...
            x = value + 5.5;
            x -= ((value + 0.5)*System.Math.Log(x));

            y = value;
            for (int j = 0; j <= 5; j++)
                z += (_gammaHelper[j]/++y);

            return -x + System.Math.Log(2.50662827463100005*z/value);
        }


        // magic constants for gamma function
        private static double[] _gammaHelper =
            new double[]
                {
                    76.18009172947146, -86.50535032941677, 24.01409824083091, -1.231739572450155, 0.1208650973866179e-2,
                    -0.5395239384953e-5
                };
        ...
        /// </exception>
        /// <remarks>
        /// <para>This method can accept an empty set, as well as the result subset size can be zero.</para>
        /// </remarks>
        public static ArrayList GetSubsetByIndex(ArrayList wholeSet, int subsetSize, long subsetIndex)
        {
            ...
            if (subsetSize < 0)
                throw new ArgumentOutOfRangeException("subsetSize", subsetSize,
                                                      "The size of a subset must be non-negative.");
            if (subsetSize > wholeSet.Count)
                throw new ArgumentOutOfRangeException("subsetSize", subsetSize,
                                                      "The size of a subset must be less than or equal to size of the whole set.");
            if (subsetIndex < 0)
                throw new ArgumentOutOfRangeException("subsetIndex", subsetIndex,
                                                      "The index of a subset must be non-negative.");
            if (subsetIndex >= BinomialCoefficient(wholeSet.Count, subsetSize))
                throw new ArgumentOutOfRangeException("subsetIndex", subsetIndex,
                                                      "The index of a subset must be less than the total number of subsets with the specified size.");
            ...
            while (subsetSize > 0)
            {
                for (;;)
                {
                    long nextSubsets = BinomialCoefficient(wholeSet.Count - currentIndex - 1, subsetSize - 1);
        ...
        /// </remarks>
        public static ArrayList GetCyclicIntervalByIndex(ArrayList wholeSet, int cyclicIntervalSize,
                                                         int cyclicIntervalIndex)
        {
            if (wholeSet == null)
                throw new ArgumentNullException("wholeSet", "The reference to the whole set cannot be null.");
            if (wholeSet.Count < 1)
            ...
            if (cyclicIntervalSize < 1)
                throw new ArgumentOutOfRangeException("cyclicIntervalSize", cyclicIntervalSize,
                                                      "The size of a cyclic interval must be at least 1.");
            if (cyclicIntervalSize >= wholeSet.Count)
                throw new ArgumentOutOfRangeException("cyclicIntervalSize", cyclicIntervalSize,
                                                      "The size of a cyclic interval must be less than or equal to size of the whole set.");
            if (cyclicIntervalIndex < 0)
                throw new ArgumentOutOfRangeException("cyclicIntervalIndex", cyclicIntervalIndex,
                                                      "The index of a cyclic interval must be non-negative.");
            if (cyclicIntervalIndex >= wholeSet.Count)
                throw new ArgumentOutOfRangeException("cyclicIntervalIndex", cyclicIntervalIndex,
                                                      "The index of a cyclic interval must be less than the number of items in the whole set.");
        ...
        public static ArrayList GetIntervalByIndex(ArrayList wholeSet, int intervalSize, int intervalIndex)
        {
            ...
            if (wholeSet.Count < 1)
                throw new ArgumentException("The whole set cannot be empty.", "wholeSet");
            if (intervalSize < 1)
                throw new ArgumentOutOfRangeException("intervalSize", intervalSize,
                                                      "The size of an interval must be at least 1.");
            if (intervalSize >= wholeSet.Count)
                throw new ArgumentOutOfRangeException("intervalSize", intervalSize,
                                                      "The size of an interval must be less than or equal to size of the whole set.");
            if (intervalIndex < 0)
                throw new ArgumentOutOfRangeException("intervalIndex", intervalIndex,
                                                      "The index of an interval must be non-negative.");
            if (intervalIndex >= wholeSet.Count - intervalSize + 1)
                throw new ArgumentOutOfRangeException("intervalIndex", intervalIndex,
                                                      "The index of an interval must be less than the total number of intervals of the specified size minus one.");
        ...
        /// </summary>
        /// <param name="point">The point (value) where the function value should be computed. This is also the variable in which we search for the solution of the function f(x) = 0.</param>
        /// <param name="hiddenParams">All other function parameters. Suitable for multi-dimensional functions.</param>
        /// <returns>The value of the examined function in the point <i>point</i>.</returns>
        /// <remarks>
        /// <para>The solution of the equation f(x) = 0 is supposed to be exactly one.</para>
        ...
        public static float BinarySearch(float left, float right, ExaminedFloatFunction function,
                                         params object[] hiddenParams)
        {
            ...
            if (function == null)
                throw new ArgumentNullException("function", "The examined function delegate must not be null.");
            ...
            if (System.Math.Sign(leftValue) == System.Math.Sign(rightValue))
        ...
        /// <param name="hiddenParams">Parameters to be passed to the examinated function f.</param>
        /// <returns>The point between left and right start point, where f(x) = 0.</returns>
        public static double BinarySearch(double left, double right, ExaminedDoubleFunction function,
                                          params object[] hiddenParams)
        {
            // check arguments
            if (left >= right)
        ...
        private static float BinarySearchInternal(float left, float right, ExaminedFloatFunction function,
                                                  bool ascendingFunction, params object[] hiddenParams)
        {
            for (;;)
            {
                ...
                {
                    if (System.Math.Sign(middleValue) < 0)
                        left = middlePoint;
                    else
                        right = middlePoint;
                }
        ...
        private static double BinarySearchInternal(double left, double right, ExaminedDoubleFunction function,
                                                   bool ascendingFunction, params object[] hiddenParams)
        {
            for (;;)
            {
        ...
        private static double IncompleteGammaInternal1(double a, double x)
        {
            ...
            for (int n = 1; n <= 1000; n++)
            {
                ...
                del *= x/ap;
                sum += del;
                if (System.Math.Abs(del) < System.Math.Abs(sum)*relativePrecision)
                    break;
            }
        ...
        private static double IncompleteGammaInternal2(double a, double x)
        {
            ...
            for (int i = 1; i <= 1000; i++)
            {
                ...
                b += 2.0;
                d = an*d + b;
                if (System.Math.Abs(d) < smallPositive)
                    d = smallPositive;
                c = b + an/c;
                if (System.Math.Abs(c) < smallPositive)
                    c = smallPositive;
                d = 1.0/d;
                del = d*c;
                h *= del;
                if (System.Math.Abs(del - 1.0) < relativePrecision) break;
            }
        ...
        public static double ChiSquarePdf(double x, int k)
        {
            ...
            if (k <= 8)
                ...
                gamma = System.Math.Exp(LogGamma(k2));
            return (System.Math.Pow(0.5, k2)*System.Math.Pow(x, k2 - 1.0)*System.Math.Exp(-x/2.0)/gamma);
        }

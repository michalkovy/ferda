...
namespace Ferda.FrontEnd.AddIns.RegEditor.MyIce
{
    /// <summary>
    /// Class for ice communication
    /// </summary>
    class RegEditorIce : SettingModuleDisp_
    {
        ...
        public RegEditorIce(Ferda.FrontEnd.AddIns.IOwnerOfAddIn ownerOfAddIn)
        {
        ...
        public override PropertyValue run(PropertyValue valueBefore, string propertyName, BoxModulePrx boxModuleParam, string[] localePrefs, ManagersEnginePrx manager, out string about, Ice.Current current__)
        {
            ...
            RegEditor.RegularExpEditor control =
                new RegEditor.RegularExpEditor(XMLString.stringValue, localePrefs[0]);
        ...
        {
            Ferda.FrontEnd.AddIns.RegEditor.RegularExpEditor control =
                (Ferda.FrontEnd.AddIns.RegEditor.RegularExpEditor)sender;

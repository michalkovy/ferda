...
namespace Ferda.FrontEnd.Desktop
{
    ...
    class FerdaDesktop : GraphControl, IViewDisplayer, IBoxSelector
    {
        ...
        /// </summary>
        private void DeleteFromDesktopCore()
        {
            foreach (BoxNode bn in SelectedShapes)
            {
                IBoxModule box = bn.Box;
        ...
        /// </summary>
        private void DeleteFromArchiveCore()
        {
        ...
        /// </summary>
        private void LocalizeInArchiveCore()
        {
            IBoxModule box;
            if (Hover == null)
            {
        ...
        /// </summary>
        private void PackAllSocketsCore()
        {
            IBoxModule box;
            if (Hover == null)
            {
        ...
        /// </summary>
        private void UnpackOneLayerAllSocketsCore()
        {
            IBoxModule box;
            if (Hover == null)
            {
        ...
        /// </summary>
        private void UnpackAllLayersAllSocketsCore()
        {
            IBoxModule box;
            if (Hover == null)
            {
        ...
        protected ContextMenuStrip CreateBoxContextMenu(IBoxModule box)
        {
            ...
            ToolStripMenuItem userNote = new ToolStripMenuItem(ResManager.GetString("UserNote"));
            ...
            if (SelectedBoxes.Count > 1)
            {
                ...
                //adding
                cMenu.Items.AddRange(new ToolStripItem[] { userNote,

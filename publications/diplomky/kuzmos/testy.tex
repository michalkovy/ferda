...
''pøekládají'' do pøirozeného jazyka. Ze zadání úlohy jsme získali nìjaká tvrzení o faktech, které platí pro klienty
...
\end{center}
\caption{Výsledky bìhu úlohy s použitím 4FT vrituálního atributu}
\label{fig:4ftresult}
\end{figure}
\paragraph{}

Zkoumejme získanou hypotézu s id 0 z výsledku bìhu úlohy 1, která zní:
\begin{description}
...
\end{description}
Tato hypotéza mùže znamenat, že pro klienty z Výškova, kteøí mají tendenci pøevádìt na úèet menší èástky a mají plat v rozmezí,
...
Tato hypotéza mùže znamenat, že pro klienty z Jièína, kteøí mají tendenci vkládat na úèet menší èástky a mají plat v rozmezí,

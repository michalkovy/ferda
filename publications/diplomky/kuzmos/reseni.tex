...
se musí do prostøedí Ferda DataMiner pøidat bez vyuití LISp-Mineru.
\paragraph{}
...
a vıstup se zapojuje do krabièek dataminingovıch procedur stejnì jako z existujících krabièek
...
a dalších pøedem pøipravenıch prostøedkù, jako jsou rozhraní, abstraktní tøídy apod.
Mnoho z tìchto prostøedkù bylo v prùbìhu implementace uzpùsobeno pro
relaèní datamining, jak bude podrobnìji popsáno v kapitole \ref{implementationdetails}.
Na druhou stranu pøi implementaci autor vy\-tvoøil další prostøedky usnad\-òující
...
moné vyuít jedné z hlavních vıhod existující implementace
...
je monost práce s prostøedím Ferda DataMiner na více platformách.

...
neposkytuje vısledek pro prohlíení uivatelem (narozdíl od bìnıch
...
''jednoprvková podmnoina''. V prostøedí Ferda DataMiner proto vystupují na místì
...
k objektu z hlavní datové matice. Potom bude moné generovat virtuální sloupec
...
\paragraph{}
Za pouití \emph{CountVectoru} lze generovat celı virtuální sloupec, potamo odpovídajicí
...
byla stanovena po øadì, protoe, jak bylo zjištìno pøi implementaci dané diplomové práce,
...
Existující dataminingové procedury musely bıt rozšíøeny o metody umoòující
...
o monost práce s jinım druhém cache pro bitové øetízky.
...
Mohou pouívat cache pro bitové øetízky virtuálních atributù, CountVector a další
navrené postupy.
...
neodpovídá ádnı záznam hlavní datové matice, úloha skonèi chybou. Vıznam mùeme chápat
následujícím zpùsobem: máme-li databázi banky a v ní tabulky pro klienty a transakce
...
Zde je zobrazen seznam existujících kategorií. Kategorie mùe bı pøejmenována 
...
\paragraph{}
Pøi vyvolání obrazovky pro pøidání intervalù se uivatel dostane rovnou na pøidání intervalù
do novì vytvoøené kategorie. Ve formuláøi uivatel vybere typy hranic intervalu a hodnoty krajních bodù,
poté kliknutím na tlaèítko ''Pøidat do kategorie'' pøidá interval do kategorie. Tento se poté zobrazí
v seznamu intervalù dané kategorie a mùe bıt odebrán dvojitım kliknutím na nìm.
\paragraph{}
...
\end{center}
\end{figure}
Pøi vyvolání obrazovky pro pøidání vıètu se uivatel dostane rovnou na pøidání hodnot do vıètu
novì vytvoøené kategorie. Ve formuláøi uivatel mùe vybrat zatím nepokryté hodnoty ve sloupci
a pøidat je do vıètu novì vytváøené kategorie kliknutím na pøíslušné tlaèítko. Hodnota
se poté objeví ve vıètu hodnot dané kategorie. Odtud mùe bıt odstranìna kliknutím na pøíslušné
tlaèítko.
\paragraph{}
Po pøidání intervalù do novì vytváøené kategorie lze potvrdit pøidání kategorie tlaèítkem ''OK''.
Pro zrušení pøidání kategorie se pouije tlaèítko ''Storno''.
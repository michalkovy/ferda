...
je strojové získávání ne\-tri\-viálních, døíve neznámých
skrytých vztahù z dat získaných pozorováním nebo z libo\-volnì vel\-kých data\-bází.
Takto nalezené vztahy mohou být re\-pre\-zentovány ve sro\-zumi\-telné
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=10cm]{pics/guha.eps}
\end{center}
...
\section[Existující implementace]{Existující implementace a jejich vztah k dané diplomové práci}
...
více vývojáøù, se rychle stává nejrozsáhlejší implementaci metody GUHA.
\paragraph{}

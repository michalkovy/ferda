...
databáze, kde každá hodnota každého atributu je reprezentována bitovým øetízkem
...
V relaèním rozšíøení dataminingových procedur GUHA se pracuje nad více tabulkami,
...
mají zaplatit nìjaké služby -- napøíklad inkaso apod. Lze pøedpokládat, že na status úvìru bude mít vliv, zda je klient

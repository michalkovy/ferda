...
The program should create an attribute for all columns in the table. It should decide a type of attribute depending on a data in a column. Similarly, it should create an atom setting from an attribute. All these atom settings should be included in a cedent setting.  

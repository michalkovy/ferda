...
Lambda is one of the most important expression for functional languages. Its base is in the lambda calculus. Mathematics many times define a function which they later use. For example
\begin{eqnarray*}
f(x)&=&1 + x\\
y&=&f(9)
\end{eqnarray*}
...
y&=&f(9)
\end{eqnarray*}
The naming of functions is not necessary, it can be also written as $(\lambda x.(1+x))(9)$.
...
The last example is written in more commonly used functional languages today, in the Python:
\begin{verbatim}

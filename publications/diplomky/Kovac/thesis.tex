...
Every programming language has from beggining at least small set of functions. Also it has some way how to use these functions to create more complex ones.

\subsection{Boxes for math}

\subsubsection{Binary operation}
\includegraphics[width=10.8cm]{binaryOperation1.png}
\includegraphics[width=10.8cm]{binaryOperation2.png}

\subsubsection{Comparision}
\includegraphics[width=10.8cm]{compare1.png}
\includegraphics[width=10.8cm]{compare2.png}

\subsubsection{If expressions}
\includegraphics[width=10.8cm]{ifthenelse1.png}
...
\includegraphics[width=10.8cm]{lambdaBasic1.png}

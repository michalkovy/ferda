...
\item[Prostøedky \uv{Mining Processor}] byly vyuity pro implementaci hy\-po\-té\-z\-ové\-ho atributu. Relaèní rozšíøení vyuívají zadání úlohy
...
dát pouze \uv{další} bitovı øetízek bez monosti zjistit, kterı další to bude, jakı
...
pro generování koeficientù \uv{AtomSetting}, protoe pracuje s po\-a\-dav\-kem \uv{poskytni
pøesnì tento bitovı øetízek}, kdeto hypotézovı atribut by umìl zpracovat pouze
poadavek \uv{poskytni další bitovı øetízek}. Tudí krabièka pro generování koeficientù
...
protoe by tam chybìlo uivatelské nastavení, vše se odehrávalo \uv{pod kapotou}.
...
\paragraph{}
Tento modul je spouštìn nad krabièkou \uv{Statickı atribut} a umoòuje
